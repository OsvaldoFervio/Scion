            ...
            <div class="right_col" role="main" style="min-height: 941px;">
                ...
                <?php if(session()->get('success')) : ?>
                        <div class="alert alert-success">videojuego creado</div>
                    <?php endif ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="<?= base_url('Dashboard/createGame') ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field() ?>
                                ...
                                <div class="row" id="award-container"></div>
                                <div class="row">
                                    <h3>Reglas</h3>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div id="stage-container" class="row col-md-12"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
